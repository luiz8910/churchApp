                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('exhibitors.update', ['exhibitors' => $id]) }}" id="form" method="post" enctype="multipart/form-data">
                                        {{ method_field('PUT') }}
                                        ...
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-group-addon">
                                                            ...
                                                            <textarea name="description" class="form-control"
                                                                   placeholder="Descrição do Expositor" rows="6" required>{{ $model->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-info font-blue"></i>
                                                            </span>
                                            ...
                                            <div class="caption caption-md">
                                                ...
                                                <span class="caption-subject font-blue-madison bold uppercase">Adicionar/Editar Responsável</span>
                                            </div>
                                            <hr><br>
                                            ...
                                            <div class="row">
                                                            ...
                                                            <select type="text" name="responsible" class="form-control selectpicker"
                                                                ...
                                                                @foreach($people as $person)
                                                                    <option value="{{ $person->id }}"
                                                                        @if($person->id == $resp) selected @endif >
                                                                        {{ $person->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="col-md-3">
                                                    <button class="btn btn-info" style="margin-top: 24px" onclick="addResponsible('new-responsible');">
...
<script src="../js/exhibitors.js"></script>
