...
<div class="content">
    ...
    <form class="login-form" role="form" method="POST" action="{{ url('/login') }}">
        ...
        <div class="create-account">
            <p>
                <a href="javascript:;" id="register-btn" class="uppercase">Crie sua conta</a>
            </p>
        </div>
    </form>
    <!-- END LOGIN FORM -->
    ...
    <form class="register-form" action="index.html" method="post">
        ...
        <div class="form-actions">
            ...
            <button type="submit" id="register-submit-btn" class="btn btn-success uppercase pull-right">Salvar</button>
        </div>
    </form>
