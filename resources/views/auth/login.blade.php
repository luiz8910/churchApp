        ...
        <div class="col-sm-7 pt-15 h-100-vh">
            <div class="row">
                <div class="col-sm-7 mr-sm-auto ml-sm-5">
                    <h6 class="color-grape">ACESSAR</h6>
                    <p class="inner-text">Faça seu login utilizando seu usuário e senha</p>

                    <form class="form-dark" role="form" method="POST" action="{{ url('/login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group p-relative {{ $errors->has('password') ? ' has-error' : '' }}">
                            <a href="{{ route("forgot.password") }}" class="input-helper">Esqueceu sua senha?</a>
                            <label class="has-float-label" aria-label="Senha">
                        ...
                        <div class="form-group pt-3 d-flex justify-content-between align-items-baseline">
                            <label class="custom-control custom-checkbox">
                                ...
                                <span class="custom-control-description"><a href="#">Lembrar-me</a></span>
                            </label>
