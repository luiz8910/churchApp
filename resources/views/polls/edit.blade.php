                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <form action="{{ route('polls.update', ['id' => $model->id]) }}" method="POST" role="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" name="name" class="form-control" autocomplete="new-password"
                                                               placeholder="Ex: Você vai participar deste evento?" required value="{{ $model->name }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="event">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon input-icon-sm">
                                                        ...
                                                        <select class="form-control" id="select-event" name="event_id" required>
                                                            <option value="">Selecione</option>
                                                            @foreach($events as $event)
                                                                <option value="{{ $event->id }}"
                                                                        @if($model->event_id == $event->id) selected @endif>
                                                                    {{ $event->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d">
                                                        ...
                                                        <input type="text" class="form-control" name="expires_in" required
                                                               placeholder="Data que a enquete se encerra" readonly value="{{ $model->expires_in }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control timepicker timepicker-24" required
                                                               name="expires_in_time" placeholder="Data que a enquete se encerra" readonly value="{{ $model->expires_in_time }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                            ...
                                            <div class="portlet-title">
                                                <div class="caption font-red-sunglo">
                                                    ...
                                                    <span class="caption-subject bold uppercase"> Opções</span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-11">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="opt[][{{ $i->id }}]" value="{{ $i->description }}">
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="col-md-1">
                                                    <a href="javascript:" class="btn btn-danger btn-circle btn-del-item" id="btn-del-item-{{ $i->id }}">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="javascript:" class="btn btn-info btn-outline" id="addOption">
