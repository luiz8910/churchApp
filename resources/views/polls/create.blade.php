                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Nova Enquete</span>
                                    </div>
                                    <!--<div class="actions">
                                        <div class="btn-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" name="name" class="form-control" autocomplete="new-password"
                                                               placeholder="Ex: Você vai participar deste evento?" required value="{{ old('name') }}">
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <select class="form-control" id="select-event" name="event_id" required>
                                                            ...
                                                            @foreach($events as $event)
                                                                <option value="{{ $event->id }}"
                                                                        @if(old('events') == $event->id) selected @endif>
                                                                    {{ $event->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d">
                                                        ...
                                                        <input type="text" class="form-control" name="expires_in" required
                                                               placeholder="Data que a enquete se encerra" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control timepicker timepicker-24" required
                                                               name="expires_in_time" placeholder="Data que a enquete se encerra" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="opt_1" required placeholder="Ex: Sim, Não, talvez, tenho interesse">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="opt_2" required placeholder="Ex: Sim, Não, talvez, tenho interesse">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
