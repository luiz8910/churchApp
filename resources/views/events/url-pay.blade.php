        ...
        <div class="col-sm-7 pt-15 h-100-vh">
            <div class="row">
                <div class="col-sm-7 mr-sm-auto ml-sm-5">
                    ...
                    <form class="form-dark" action="{{ route('event.payment.url', ['url_id' => $url->id]) }}" method="POST" id="form-sub-pay">
                        ...
                        <div class="form-group justify-content-between align-items-center border-bottom" id="form-courses">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="custom-control custom-checkbox" >
                                            <input type="checkbox" class="custom-control-input course" id="course-{{ $item->event_id }}"
                                                   name="course-{{ $item->event_id }}">
                                            <span class="custom-control-indicator"><i class="fas fa-check"></i></span>
                                            <span class="custom-control-description">{{ $item->event_name }}</span>
                                            <input type="hidden" id="course-value-{{ $item->event_id }}" value="{{ $item->value_money }}">
                                        </label>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <input type="hidden" value="{{ $url->installments }}" id="max_installments">
