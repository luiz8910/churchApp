                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Novo Palestrante</span>
                                    </div>
                                    <!--<div class="actions">
                                        <div class="btn-group">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('speakers.store') }}" id="form" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail"
                                                                ...
                                                                <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=foto+do+Palestrante"
                                                                     alt=""/></div>
