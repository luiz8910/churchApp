                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="customer_id" id="customer_id" class="form-control" required>
                                                            ...
                                                            @foreach($orgs as $org)
                                                                <option value="{{ $org->id }}" @if($invoice->customer_id == $org->id) selected @endif>{{ $org->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="input-group input-icon right">
                                                                <span class="input-group-addon">
                                                                    ...
                                                                    <input type="text" name="email" id="email" class="form-control"
                                                                           placeholder="email@dominio.com" value="{{ $invoice->email }}" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date date-picker" data-date-format="dd/mm/yyyy">
                                                            ...
                                                            <input type="text" class="form-control input-date" name="date" autocomplete="new-password"
                                                                   placeholder="dd/mm/aaaa" maxlength="10" value="{{ $invoice->date }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group" id="div_qtde">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control number" id="qtde" placeholder="1000" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
