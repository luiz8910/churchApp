                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Novo Fornecedor</span>
                                    </div>
                                    <!--<div class="actions">
                                        <div class="btn-group">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('providers.store') }}" id="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=logo+do+Fornecedor" alt="" /> </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-group-addon">
                                                            ...
                                                            <textarea name="description" class="form-control" id="description"
                                                                      placeholder="Descrição do Fornecedor" required style="height: 125px;">
                                                                {{ old('description') }}
                                                            </textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="url" name="site" class="form-control url"
                                                                   placeholder="Site do Fornecedor"
                                                                   value="{{ old('site') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <button class="btn btn-info" style="margin-top: 24px" onclick="addResponsible('new-responsible-provider');">
