...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin Theme #3 | Calendar</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1" name="viewport" />
    <meta content="Preview page of Metronic Admin Theme #3 for calendar page" name="description" />
                                        ...
                                        <div class="portlet light portlet-fit  calendar">
                                            ...
                                            <div class="header-box-calendario">
                                                <ul class="pagination ">
                                                    ...
                                                    <li>
                                                        <a class="btn-pagination" href="javascript:;"> Maio </a>
                                                    </li>
                                                    <li class="active">
                                                        <a href="javascript:;"> <strong>Junho</strong> </a>
                                                    </li>
                                                    <li>
                                                        <a class="btn-pagination" href="javascript:;"> Julho </a>
                                                    </li>
                                                    <li>
                                                        <a class="btn-pagination" href="javascript:;">
                                                ...
                                                <div class="ano-calendario">
                                                    <p class="ano-calendario"><strong>2017</strong></p>
                                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <!-- INICIO DO DIA -->
                                                                <td class="adjust-td-body-table">
                                                                    <p class="text-right p-dia-mes">25</p>

                                                                    <a href="">
                                                                        <div class="evento-calendario cor-1">
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td class="adjust-td-body-table">
                                                                    ...
                                                                    <a href="">
                                                                        <div class="evento-calendario cor-1">Limpeza da igreja completa</div>
                                                                    </a>
