...
class SpeakerController extends Controller
{
    ...
    public function __construct(SpeakerRepository $repository, SpeakerCategoryRepository $categoryRepository,
    ...
    public function index($event_id = null)
    {
        if($event_id)
        {
            ...
            $bug->platform = 'App';
            $bug->location = 'index() Api\SpeakerController.php';
            $bug->model = 'Speaker';
            $bug->status = 'Pendente';
            $bug->church_id = 0;
    ...
    /*
     * Mostra os detalhes de um palestrante.
     */
     ...
     * (Pode-se atrelar um palestrante ao evento)
     */
        ...
        try{
            ...
            if($data['event_id'])
            {
                ...
                if($event)
                {
                    ...
                    $bug->platform = 'App';
                    $bug->model = 'Speaker';
                    $bug->location = 'store() Api\SpeakerController.php';
                    $bug->status = 'Pendente';
                    $bug->church_id = 0;
    ...
    /*
     * Usado para atualizar as info de um palestrante
     */
    public function update(Request $request, $id)
    {
        ...
        if($speaker)
        {
            ...
            $bug->platform = 'App';
            $bug->model = 'Speaker';
            $bug->location = 'update() Api\SpeakerController.php';
            $bug->status = 'Pendente';
            $bug->church_id = 0;
    ...
    /*
     * Usado para excluir um palestrante
     */
    ...
    /*
     * Usado para retornar palestrantes por categoria
     */
    ...
    public function index_cat($event_id = null)
    {
        if($event_id)
        {
            ...
            if($event)
            {
                ...
                $bug->platform = 'App';
                $bug->location = 'index_cat() Api\SpeakerController.php';
                $bug->model = 'Speakers';
                $bug->status = 'Pendente';
                $bug->church_id = 0;
    ...
    /*
     * Cadastra uma nova categoria de palestrante
        ...
        if(isset($data['event_id']) && $data['event_id'] != "")
        {
            ...
            if($event)
            {
                ...
                }catch (\Exception $e)
                {
                    ...
                    $bug->description = $e->getMessage();
                    $bug->platform = 'App';
                    $bug->location = 'store_cat() Api\SpeakerController.php';
                    $bug->model = 'Speakers';
                    $bug->status = 'Pendente';
                    $bug->church_id = 0;
    ...
    /*
     * Alteração de uma categoria de palestrante
     */
        ...
        if($cat)
        {
            ...
            if(isset($data['event_id']) && $data['event_id'] != "")
            {
                ...
                if($event)
                {
                    ...
                    $bug->description = 'O evento(id: '.$data['event_id'].') que esta categoria pertence não existe';
                    $bug->platform = 'App';
                    $bug->location = 'update_cat() Api\SpeakerController.php';
                    $bug->model = 'Speakers';
                    $bug->status = 'Pendente';
                    $bug->church_id = 0;
        ...
        if($cat)
        {
            ...
            if($speakers)
            {
                ...
                }catch (\Exception $e)
                {
                    ...
                    $bug->description = $e->getMessage();
                    $bug->platform = 'App';
                    $bug->location = 'delete_cat() Api\SpeakerController.php';
                    $bug->model = 'Speakers';
                    $bug->status = 'Pendente';
                    $bug->church_id = 0;
