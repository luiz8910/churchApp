												...
												<div class="portlet light">
													<div class="portlet-title">
														<div class="caption font-green-haze">
															...
															<span class="caption-subject font-green-haze bold">Crianças e Jovens</span>
														</div>
														<div class="actions">
															<div class="btn-group btn-group-sm">
																...
																<div class="col-lg-3">
																	<div class="btn-group-devided">
																		<a role="button" class="btn btn-info btn-circle btn-sm" href="{{ route('teen.create') }}" style="margin-top: 2px;">
